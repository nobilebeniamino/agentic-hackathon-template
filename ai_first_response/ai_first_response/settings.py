"""
Django settings for ai_first_response project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-mlmq-+2(!#8h(as_px+_+8bhf(3e)x_((wc*rezh73s02y4!&j')
...
WSGI_APPLICATION = 'ai_first_response.wsgi.application'
